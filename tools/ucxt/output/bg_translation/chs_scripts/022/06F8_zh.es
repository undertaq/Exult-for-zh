...
labelFunc06F8_0386:
	...
	Func08FF("@Erethian 对力量的渴望让他落得如此邪恶的下场，真是令人悲哀。@");
	Func08FF("@也许他终于得到了安息。@");
labelFunc06F8_03A7:
	if (!(!UI_is_dead(0xFFE9))) goto labelFunc06F8_03B8;
	Func08FF("@我确信不列颠王此刻正在等待 Exodus 被放逐的消息。@");
labelFunc06F8_03B8:
	Func08FF("@是时候离开这座荒凉的岛屿了。@");
	abort;
labelFunc06F8_03BF:
...
labelFunc06F8_05A7:
	...
	message("「不！你绝不能这么做！」Erethian 的声音充满了痛苦。他举起双臂，开始吟唱一道强大的咒语。");
	say();
	message("「Vas Ort Rel Tym...」");
	say();
	message("他在咒语念到一半时停了下来，开始念另一个咒语，并指向无限护身符。");
	say();
	message("「Vas An Ort Ailem!」");
	say();
	message("你立刻认出这是法术出错的共鸣，显然 Erethian 也察觉到了。恐惧的神色出现在他布满皱纹的脸上，他的皱纹似乎每一秒都在加深。*");
	say();
