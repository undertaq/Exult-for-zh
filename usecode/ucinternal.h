...
class Usecode_internal : public Usecode_machine {
	...
	std::vector<std::pair<int, int>> voice_string_trace;  // (func_id, offset) pairs from ADDSI.
	std::vector<std::pair<int, int>> voice_pushs_trace;   // (func_id, offset) pairs from PUSHS.
