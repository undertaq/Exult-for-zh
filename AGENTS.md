...
## Memory - AutoMem (persistent context for Exult-for-zh)
...
mcp__memory__recall_memory({
  ...
  tags: ["Exult-for-zh"],        // drop if slug collides with a common word
...
mcp__memory__store_memory({
  ...
  type: "Decision",
  tags: ["<category>", "Exult-for-zh", "<language>"], // bare strings; NO platform tag, NO [YYYY-MM]
  importance: 0.85,
  confidence: 0.9
})
```
