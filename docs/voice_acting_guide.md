...
1. **NPC 專屬語音**（若有指定 NPC）：`009a_12df_0_npc286.ogg`
2. **通用語音**：`009a_12df_0.ogg`
3. **跨語言備援**：若以上皆無，則嘗試另一語言的對應檔案
4. **second_source 目錄**：每個語言目錄下都有 `second_source/` 子目錄，順序在 primary 之後
