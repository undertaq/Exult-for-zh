if(NOT DEFINED X_VCPKG_BUILD_GNU_LIBICONV)
    ...
    if(VCPKG_TARGET_IS_WINDOWS OR VCPKG_TARGET_IS_IOS OR VCPKG_TARGET_IS_BSD)
        # Skip building GNU libiconv on Windows — use the CRT built-in iconv
        # via CMake's FindIconv module. On MSVC, _iconv() is provided by
        # ucrtbase.dll, so no separate library is needed. This avoids the
        # extremely slow msys2-based autotools configure/make step.
        set(X_VCPKG_BUILD_GNU_LIBICONV 0)
...
if(NOT X_VCPKG_BUILD_GNU_LIBICONV)
    message(STATUS "Not building GNU libiconv (using system iconv).")
...
# Only reached on platforms that need a real build (Android < 28).
